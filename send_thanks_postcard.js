...
Lob.postcards.create({
    description: 'Lob Love Letters Thanks Postcard',
    to: FRIENDS_ADDRESS,
    from: MY_ADDRESS,
    front: fs.createReadStream('./assets/ThanksPostcardFront.html'),
    back: fs.createReadStream('./assets/ThanksPostcardBack.html'),
    merge_variables: {
        recipient,
        message,
        closing,
